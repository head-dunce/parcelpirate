...
@foreach ($statuses as $status)
    ...
    <div class="status-section">
        ...
        <form method="post" action="{{ route('status.update.bulk') }}">
            ...
            Change all <i>{{ $status->package_status_name }}</i> statuses to:
        ...
        <div class="table-container">
            <table>
                <tr>
                    ...
                    <th class="parcel-td-mobile">Parcel</th>
                ...
                <tr>
                    <form method="post" action="{{ route('packages.updateStatus', ['package' => $package->id]) }}">
                        ...
                        <td class="parcel-td-mobile">
                            @auth
                                @if(auth()->user()->hasVerifiedEmail())
                                    <a href="{{ url('/packages/edit/'.$package->id) }}" class="button-edit"><b>EDIT</b></a>
                                @else
                                    <div class="info">Please verify your email to edit parcels.</div>
                                @endif
                            @endauth
                            ...
                            @if(!empty($package->TrackingNumber))
                                <b>Tracking:</b><br>
                                {{ $package->TrackingNumber }}<br><br>
                            @endif
                            @if(!empty($package->Carrier))
                                <b>Carrier:</b><br>
                                {{ $package->Carrier }}<br><br>
                            @endif
                            @if(!empty($package->PackageValue))
                                <b>Value:</b><br>
